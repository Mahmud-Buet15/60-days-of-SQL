select * from data_bank.customer_nodes; --3,500
select * from data_bank.customer_transactions; --5,868
select * from data_bank.regions;--5
...
select count(distinct customer_id) from data_bank.customer_transactions; --500
